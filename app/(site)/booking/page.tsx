...
export const metadata: Metadata = {
  ...
  keywords: [
    "book transfer Switzerland",
    "book taxi online",
    "transfer booking",
    "instant price transfer",
    "online taxi reservation",
    "book chauffeur",
    "fixed price transfer",
    "no hidden fees taxi",
    "free cancellation transfer",
    "book airport transfer Zurich",
    "reserve limousine Switzerland",
    "quick booking taxi",
    "last minute transfer",
    "same day booking",
    "Transfer buchen Schweiz",
    "Taxi online bestellen",
    "Chauffeur reservieren",
    "Festpreis Transfer",
    "Flughafentransfer buchen",
    "sofort Bestätigung",
    "réserver transfert Suisse",
    "réservation taxi en ligne",
    "prix fixe transfert",
    "réserver chauffeur",
    "confirmation instantanée",
    "prenotare trasferimento",
    "prenotazione taxi online",
    "prezzo fisso",
    "prenotare NCC",
    "conferma immediata",
