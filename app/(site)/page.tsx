...
export const metadata: Metadata = {
  title:
    "Premium Transfer & Taxi Service Switzerland | Luxury Chauffeur Zurich Geneva Basel",
  description:
  ...
  keywords: [
    ...
    "limousine service Zurich",
    "private driver",
    "Mercedes S-Class chauffeur",
    "Mercedes V-Class transfer",
    "premium taxi",
    "corporate car service",
    "business chauffeur Zurich",
    "executive transfer",
    "ski transfer Switzerland",
    "hotel transfer Zurich",
    "wedding transfer",
    "meet and greet Zurich airport",
    "door to door transfer",
    "fixed price taxi",
    "Transfer Schweiz",
    "Taxi Zürich",
    "Luxus Chauffeur Zürich",
    "Flughafentransfer",
    "VIP Fahrdienst",
    "Mercedes Chauffeur",
    "Privater Fahrer",
