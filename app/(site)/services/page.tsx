...
export const metadata: Metadata = {
  ...
  keywords: [
    "airport transfer Zurich ZRH",
    "airport transfer Geneva GVA",
    "airport transfer Basel",
    "meet and greet airport",
    "flight tracking transfer",
    "business chauffeur Switzerland",
    "corporate car service Zurich",
    "executive transfer",
    "VIP transfer Switzerland",
    "VIP transportation Zurich",
    "celebrity transfer",
    ...
    "Business Chauffeur Schweiz",
    "VIP Fahrdienst",
    "Ski Transfer Alpen",
    "Hochzeitsauto Schweiz",
    "Langstrecken Transfer",
    "Firmentransfer",
    "Messetransfer",
    "Stündlicher Chauffeur",
    "transfert aéroport Zurich",
    "chauffeur entreprise",
    "VIP transport Suisse",
    "transfert ski",
    "voiture mariage",
    ...
    "trasferimento sci",
    "auto matrimonio",
    "transfer lungo raggio",
    "трансфер аэропорт",
    "бизнес трансфер",
    "VIP трансфер",
    "трансфер горнолыжный",
    "свадебный трансфер",
