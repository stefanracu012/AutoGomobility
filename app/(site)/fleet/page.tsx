...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "luxury fleet Switzerland",
    "premium vehicles transfer",
    "sedan hire Zurich",
    "SUV transfer Switzerland",
    "minivan chauffeur",
    "first class vehicle",
    "business class car",
    "economy transfer vehicle",
    "leather interior car service",
    "WiFi in car transfer",
    "child seat transfer",
    "Fahrzeugflotte Schweiz",
    "Mercedes mieten Zürich",
    "Luxusauto mit Fahrer",
    "Limousine mieten",
    "Premium Fahrzeuge",
    "S-Klasse Chauffeur",
    "flotte de véhicules Suisse",
    "Mercedes avec chauffeur",
    "voiture de luxe",
    "location limousine",
    "véhicule premium transfert",
    "flotta veicoli Svizzera",
    "Mercedes con autista",
    "auto lusso noleggio",
    "парк автомобилей Швейцария",
    "Мерседес с водителем",
    "люкс авто",
    "аренда лимузина",
    "премиум автомобиль трансфер",
  ],
  openGraph: {
